...
import { Building, Plus, DollarSign, Clock, CheckCircle, Loader2, Eye, CheckCircle2, XCircle, Target, BarChart3 } from 'lucide-react'
...
const NGODashboard = () => {
    ...
    try {
      ...
      const transformedVaults = vaultObjects.map(obj => {
        ...
        return {
          ...
          minAmount: parseInt(fields.minAmount || '0'),
          contributedAmount: parseInt(fields.contributedAmount || '0'),
  ...
  const handleCreateVault = async (e) => {
    ...
    if (!formData.dreamId || !formData.matchAmount || !formData.minAmount) {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Manage dream approvals and create matching vaults to support community aspirations
          </p>
        </div>
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            By: {dream.owner.slice(0, 8)}...{dream.owner.slice(-6)}
                          </p>
                        </div>
                    ...
                    <div key={dream.id} className="card p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className={`status-badge ${
                          dream.isComplete ? 'status-completed' : 'status-approved'
                        }`}>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="card p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Set up a vault to provide matching funds for approved dreams
                </p>
              </div>
              ...
              <div className="mt-8 p-4 bg-primary-50 rounded-lg border border-primary-200">
                <h4 className="font-medium text-primary-800 mb-2">How matching vaults work</h4>
                  ...
                  <div key={vault.id} className="card p-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Dream ID: {vault.dreamId && vault.dreamId !== 'unknown' ? (
                            vault.dreamId.length > 20 ? `${vault.dreamId.slice(0, 12)}...${vault.dreamId.slice(-6)}` : vault.dreamId
                          ) : 'Loading...'}
                        </p>
                      </div>
                      <div className={`status-badge ${
                    ...
                    <div className="space-y-3 mb-4">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">{vault.minAmount}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Fulfilled Months:</span>
                        <span className="font-medium">{vault.contributedAmount}</span>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between text-sm mb-1">
                        <span className="text-gray-600">Progress</span>
                        <span className="font-medium">
                          {vault.minAmount > 0 ? Math.min((vault.contributedAmount / vault.minAmount) * 100, 100).toFixed(0) : 0}%
                        </span>
                      </div>
                      <div className="progress-bar">
                        <div 
                          className="progress-fill"
                          style={{ width: `${vault.minAmount > 0 ? Math.min((vault.contributedAmount / vault.minAmount) * 100, 100) : 0}%` }}
                        ></div>
                      </div>
                    </div>
                    ...
                    {/* Actions */}
                    <div className="flex gap-2">
                      {vault.isActive && vault.contributedAmount < vault.minAmount && (
                        <button
